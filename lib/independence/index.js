...
Axios.prototype.independent = function () {
  const originalAdapter = this.defaults.adapter
  this.defaults.adapter = generateIndependenceAdapter(originalAdapter)
  this.interval = setInterval(() => retryPendingRequests(originalAdapter), RETRY_TIME)
